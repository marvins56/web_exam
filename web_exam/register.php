...
if(isset($_POST['submit'])){
  ...
  $password2 = mysqli_real_escape_string($con, $_POST['password2']);
    $interest = mysqli_real_escape_string($con, $_POST['interest']);
          ...
          if(empty($interest))
          {array_push($errors,"please enter ur response");}
...
//if it doent exist register teh user
  ...
  // Finally, register user if there are no errors in the form
              if (count($errors) == 0) {
                ...
                $query = "INSERT INTO users (username, email,phoneno, password,interest)
                      VALUES('$username', '$email','$phoneno', '$password','$interest')";
...
<link rel="stylesheet" href="style.css">
  ...
  <body>
    <div class="after">
<img src="img3.jpeg" alt=""> <span>IEEE CONFRENCE REGISTRATION FORM</span>
    </div>
    <section>
 ...
 <span class="img"> <img src="img5.png" alt="">  </span>
  ...
  <span class="error_space">   <?php echo "*"; include('errors.php'); ?></span>
            ...
            <label for="">1:networks  2: software dev 3: cloud cpmouting 4:robotics and AI</label>
                     <input type="number" name="interest" value="" placeholder="Area of interst in Technology">
                  </div>
