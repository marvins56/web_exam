...
$user_check_query = "SELECT * FROM users WHERE username='$username' or email='$email' or password = '$password2' LIMIT 1";
...
//encrypting the password
  ...
  $query = "SELECT * FROM users WHERE username='$username' or email = '$email' or password='$password2'";
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>IEEE CONFRENCE LOGIN </title>
    <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous"/>
<link rel="stylesheet" href="style.css">
  </head>
  <body>
    <div class="after">
<img src="img3.jpeg" alt=""> <span>IEEE CONFRENCE  LOGIN FORM</span>
    </div>
    <section>
          ...
          <form  method="post">
              <span class="error_space">   <?php echo "*"; include('errors.php'); ?></span>
                  ...
                  <div class="buttons">
                     ...
                     <p>Dont have an account? <a href="register.php">Create account </a>
                     </p>
                  </div>
          </form>
        </div>
